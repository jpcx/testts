...
const otherFileFail = test("continues testing after single file failure", () => {
  ...
  // @ts-ignore
  if (global.testtsReportFailure) {
    // @ts-ignore
    global.testtsReportFailure(otherFileFail);
  } else {
    // @ts-ignore
    global.testtsOtherFileFailure = otherFileFail;
  }
});
// @ts-ignore
if (global.testtsReportExpectedFailure) {
  // @ts-ignore
  global.testtsReportExpectedFailure(otherFileFail);
} else {
  // @ts-ignore
  global.testtsExpectedOtherFileFailure = otherFileFail;
}
